...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return GameServiceProto.internal_static_PlayerEvent_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return GameServiceProto.internal_static_PlayerEvent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            PlayerEvent.class, PlayerEvent.Builder.class);
  }
  ...
  public static PlayerEvent parseFrom(
  ...
  public static PlayerEvent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static PlayerEvent parseFrom(
  ...
  public static PlayerEvent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static PlayerEvent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static PlayerEvent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(PlayerEvent prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using savonitar.click2win.protobuf.PlayerEvent.newBuilder()
    private Builder() {
    ...
    @Override
    public PlayerEvent getDefaultInstanceForType() {
      return PlayerEvent.getDefaultInstance();
    }

    @Override
    public PlayerEvent build() {
      PlayerEvent result = buildPartial();
    ...
    @Override
    public PlayerEvent buildPartial() {
      PlayerEvent result = new PlayerEvent(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof PlayerEvent) {
        return mergeFrom((PlayerEvent)other);
      } else {
    ...
    public Builder mergeFrom(PlayerEvent other) {
      if (other == PlayerEvent.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      PlayerEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (PlayerEvent) e.getUnfinishedMessage();
  ...
  private static final PlayerEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PlayerEvent();
  }

  public static PlayerEvent getDefaultInstance() {
